...
if __name__ == '__main__':
    ...
    parser.add_argument( "--context_type", help = 'roberta-large or bert-large-uncased or gpt2 or gpt2-large or gpt2-medium', default = 'gpt2-large')
    parser.add_argument( "--speaker_type", help = 'roberta-large or bert-large-uncased or gpt2 or gpt2-large or gpt2-medium', default = 'roberta-large')
